  ...
  return (
    ...
    >
        ...
        <nav className="hidden md:flex items-center space-x-8">
          {navLinks.map(link => (
            <a
              key={link.name}
              href={link.href}
              className="text-dark font-medium hover:text-secondary transition-colors duration-300"
            >
              {link.name}
            </a>
          ))}
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            className="md:hidden bg-primary pb-6"
            ...
            >
              {navLinks.map(link => (
                <motion.a
                  ...
                  className="text-dark font-medium text-lg hover:text-secondary transition-colors duration-300"
